...
# output files
output_spreadsheet_file <- file.path(outdir, "filtered_DE.csv")
output_pValue_file <- file.path(outdir, "pValue_DE.csv")
output_log2CPM_file <- file.path(outdir, "log2CPM.csv")
output_dgelist_58_file <- file.path(projectDir, "deduplicated_clearBox/output/filt_norm_dgelist_58.rds")
output_gene_wise_bcv_results_male_file <- file.path(projectDir, "deduplicated_clearBox/output/dedup_gene_wise_bcv_results_male.csv")
output_gene_wise_bcv_results_female_file <- file.path(projectDir, "deduplicated_clearBox/output/dedup_gene_wise_bcv_results_female.csv")

# set figure files
output_librarySize_file <- file.path(projectDir, "deduplicated_clearBox/output/deduplicated_librarySizePlot.png")
output_mds_file <- file.path(projectDir, "deduplicated_clearBox/output/deduplicated_58_mds.png")
...
#         file = file.path(projectDir, "deduplicated_clearBox/output/post_dedup_residuals.rds"))

# grab the fitted values
fitted_post_dedup <- fitted(fit_sex_PE)
# saveRDS(fitted_post_dedup,
#         file = file.path(projectDir, "deduplicated_clearBox/output/post_dedup_fitted.rds"))

# check the coefficients
contrast_fit_sex_PE$coefficients
...
write_csv(allTable_female_PE,
          file="/home/smit1924/preeclampsia_sex_chromosome_informed/deduplicated_clearBox/output/allTable_female_post_dedup.csv")
...
write_csv(allTable_male_PE,
          file="/home/smit1924/preeclampsia_sex_chromosome_informed/deduplicated_clearBox/output/allTable_male_post_dedup.csv")
